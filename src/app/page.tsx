...
export const metadata: Metadata = {
  title: 'Custom Phone Cases | Design Your Own Phone Case - Coverly',
  description: 'Create stunning custom phone cases with your photos. Premium quality printing, fast delivery, and perfect protection for iPhone, Samsung, Xiaomi and more. Start designing today!',
  keywords: [
    'custom phone cases',
  ...
  openGraph: {
    title: 'Custom Phone Cases | Design Your Own Phone Case - Coverly',
    description: 'Create stunning custom phone cases with your photos. Premium quality printing, fast delivery, and perfect protection for all major phone models.',
    images: [
      {
        url: '/images/hero2.png',
        width: 1200,
        height: 630,
        alt: 'Custom Phone Case Design - Coverly',
      },
    ],
    type: 'website',
  },
  twitter: {
    ...
    title: 'Custom Phone Cases | Design Your Own Phone Case - Coverly',
    description: 'Create stunning custom phone cases with your photos. Premium quality printing and fast delivery.',
    images: ['/images/hero2.png'],
  },
  alternates: {
    canonical: 'https://coverly.com',
  },
};
...
const websiteSchema = {
  ...
  potentialAction: {
    ...
    target: {
      '@type': 'EntryPoint',
      urlTemplate: 'https://coverly.com/customize?q={search_term_string}'
    },
...
const serviceSchema = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  name: 'Custom Phone Case Design Service',
  description: 'Professional custom phone case design and printing with premium quality materials and fast delivery',
  provider: {
    '@type': 'Organization',
    name: 'Coverly'
  },
  ...
  hasOfferCatalog: {
    '@type': 'OfferCatalog',
    name: 'Phone Case Customization Services',
    itemListElement: [
      {
        '@type': 'Offer',
        itemOffered: {
          '@type': 'Product',
          name: 'Custom iPhone Cases',
          description: 'Personalized iPhone cases with your photos'
        }
      },
      {
        '@type': 'Offer',
        itemOffered: {
          '@type': 'Product',
          name: 'Custom Samsung Cases',
          description: 'Personalized Samsung Galaxy cases with your photos'
        }
      },
      {
        '@type': 'Offer',
        itemOffered: {
          '@type': 'Product',
          name: 'Custom Xiaomi Cases',
          description: 'Personalized Xiaomi cases with your photos'
        }
      }
    ]
  }
